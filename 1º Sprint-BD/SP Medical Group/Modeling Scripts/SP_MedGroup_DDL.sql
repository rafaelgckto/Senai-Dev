...
BEGIN
	CREATE TABLE Endereco(
		...
		--CONSTRAINT UQ_Endereco UNIQUE (idEndereco)
	);
END
...
CREATE TABLE Clinica(
	...
	CONSTRAINT FK_HoraFuncionamento_Clinica FOREIGN KEY (idHF) REFERENCES HoraFuncionamento (idHF),
...
CREATE TABLE Consulta(
	...
	--CONSTRAINT UQ_Consulta UNIQUE (idConsulta)
);
GO
