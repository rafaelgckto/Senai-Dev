...
BEGIN
	CREATE TABLE dbo.Paciente(
		...
		CONSTRAINT FK_Usuario_Paciente FOREIGN KEY (idUsuario) REFERENCES Usuario (idUsuario),
...
BEGIN
	CREATE TABLE dbo.Medico(
		...
		CONSTRAINT FK_Usuario_Medico FOREIGN KEY (idUsuario) REFERENCES Usuario (idUsuario),
