...
namespace Senai.SP_MG.WebApi.Contexts {
    public partial class MedicalGroupContext : DbContext {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) {
            if(!optionsBuilder.IsConfigured) {
                optionsBuilder.UseSqlServer("Data Source=CELSO-PC; initial catalog=SP_MedicalGroup; user Id=sa; pwd=7895123;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<Usuario>(entity => {
                ...
                entity.HasIndex(e => new { e.Email, e.IdPaciente, e.IdMedico }, "UQ_Usuario")
                    .IsUnique();
